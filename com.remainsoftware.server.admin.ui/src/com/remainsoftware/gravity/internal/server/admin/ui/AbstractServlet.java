...
public abstract class AbstractServlet extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3449700222660298467L;
	private AbstractComponent component;

	public AbstractServlet(AbstractComponent component) {
	...
	protected void addReturnLink(StringBuffer response) {
		response.append("<p>"
				+ createLink(getAlias(), "Click here to return to admin page"));
	}

	protected String createLink(String alias, String text) {
		return "<a href=\"" + getServletContext().getContextPath() + alias
				+ "\">" + text + "</a>";
	}
